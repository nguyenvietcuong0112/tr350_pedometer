...
class MockFoodDatabase {
  static const List<FoodItem> foods = [
    FoodItem(name: 'White Rice (cooked)', caloriesPer100g: 130, protein: 2.7, carbs: 28, fat: 0.3),
    FoodItem(name: 'Maize / Corn (cooked)', caloriesPer100g: 96, protein: 3.4, carbs: 21, fat: 1.5),
    FoodItem(name: 'Wheat Bread (white)', caloriesPer100g: 270, protein: 9, carbs: 49, fat: 3),
    FoodItem(name: 'Potatoes (boiled)', caloriesPer100g: 87, protein: 1.9, carbs: 20, fat: 0.1),
    FoodItem(name: 'Chicken Thigh', caloriesPer100g: 180, protein: 24, carbs: 0, fat: 9),
    FoodItem(name: 'Chicken Breast (cooked)', caloriesPer100g: 165, protein: 31, carbs: 0, fat: 3.6),
    FoodItem(name: 'Salmon (cooked)', caloriesPer100g: 208, protein: 22, carbs: 0, fat: 13),
    FoodItem(name: 'Beef (lean, cooked)', caloriesPer100g: 250, protein: 26, carbs: 0, fat: 15),
    FoodItem(name: 'Pork (lean, cooked)', caloriesPer100g: 225, protein: 27, carbs: 0, fat: 12),
    FoodItem(name: 'Tuna (canned in water)', caloriesPer100g: 100, protein: 23, carbs: 0, fat: 0.5),
    FoodItem(name: 'Shrimp (boiled)', caloriesPer100g: 100, protein: 21, carbs: 0.2, fat: 1.1),
